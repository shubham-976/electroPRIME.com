...
const ProcessOrder = ({ history, match }) => {
  ...
  const {error:updateError, isUpdated} = useSelector((state) => state.deleteUpdateOrder_);
        ...
        <div className="newProductContainer">
          {loading ? (
            ...
            <div
              ...
              style={{
                display: order.orderStatus === "Delivered" ? "block" : "grid", //if delivered, the updateOrderForm will not be visible
              }}
            >
              <div>
                <div className="confirmshippingArea">
                  ...
                  <div className="orderDetailsContainerBox">
                    ...
                    <div>
                      <p>Ordered on:</p>
                      <span>
                        {order.createdOn && order.createdOn.substr(0, 10)}
                      </span>
                    </div>
                  </div>
