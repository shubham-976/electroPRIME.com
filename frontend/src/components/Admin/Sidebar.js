...
const Sidebar = () => {
  return (
    <div className='sidebar'>
        <Link to="/"><img src={electroPRIMELogo} alt="logo"/></Link>
        ...
        {/* <Link> */}
         <TreeView defaultCollapseIcon={<ExpandMoreIcon/>} defaultExpandIcon={<ImportExportIcon/>}>
            <TreeItem nodeId="1" label="Products">
                <Link to="/admin/products"><TreeItem nodeId="2" label="All"/></Link>
                <Link to="/admin/product"><TreeItem nodeId="3" label="Create"/></Link>
            </TreeItem>
         </TreeView>
        {/* </Link> */}
